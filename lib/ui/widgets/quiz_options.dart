...
import 'package:progquiz/models/category.dart';
import 'package:progquiz/models/question.dart';
import 'package:progquiz/resources/api_provider.dart';
import 'package:progquiz/ui/pages/error.dart';
import 'package:progquiz/ui/pages/quiz_page.dart';
            ...
            child: Wrap(
              ...
              children: <Widget>[
                ...
                ActionChip(
                  ...
                  backgroundColor: _noOfQuestions == 5 ? Colors.indigo : Colors.grey.shade600,
                ...
                ActionChip(
                  label: Text("15"),
                  labelStyle: TextStyle(color: Colors.white),
                  backgroundColor: _noOfQuestions == 15 ? Colors.indigo : Colors.grey.shade600,
                ...
                ActionChip(
                  label: Text("25"),
                  labelStyle: TextStyle(color: Colors.white),
                  backgroundColor: _noOfQuestions == 25 ? Colors.indigo : Colors.grey.shade600,
                  onPressed: () => _selectNumberOfQuestions(25),
                ),
              ],
            ),
          ),
